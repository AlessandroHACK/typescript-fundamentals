 ...
 * private vs public:
    ...
    - private: Solo el código que está dentro de las llaves {} de la clase puede ver o usar esa propiedad.
...
/**
 ...
 y cómo se modifica (escribir) el valor de una propiedad dentro de una clase.
    ...
    - El Setter (set) — El filtro de escritura
 */
export class Dog {
  ...
  get imageUrl(): string {
    // Si aún no hacemos el fetch, podemos devolver un placeholder o un texto vacío
  ...
  // 3. El método para conectar con la API y extraer el "message"
...
// Al inicio, imageUrl tendrá el placeholder
console.log('Antes del fetch:', fido.imageUrl); 

// Ejecutamos el fetch de la clase
await fido.loadOrCreateImage();

// ¡Ahora sí! El getter nos devuelve la URL final de la foto del Pug
console.log('Después del fetch:', fido.imageUrl);
